  ...
  return (
    <div className="max-w-3xl">
      ...
      {!isSetup && (
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 mb-8">
          ...
          <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
            <li>
              <Link href="/dashboard/profile" className="underline font-medium">Complete your profile</Link>
              {' '}— name, job title, experience level
            </li>
            <li>
              <Link href="/dashboard/experiences" className="underline font-medium">Import your resume</Link>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Link href="/dashboard/resume" className="bg-blue-600 text-white rounded-xl p-5 hover:bg-blue-700 transition-colors shadow-sm">
          <div className="font-semibold">Generate resume</div>
          <div className="text-blue-100 text-sm mt-1">Tailored to any job description</div>
        </Link>
        <Link href="/dashboard/experiences" className="bg-white border border-gray-200 rounded-xl p-5 hover:bg-gray-50 transition-colors shadow-sm">
          <div className="font-semibold text-gray-900">View my data</div>
          <div className="text-gray-500 text-sm mt-1">Experiences, skills, education</div>
        </Link>
      </div>

      <p className="mt-8 text-sm text-gray-500">
        Use WhatsApp to log voice updates on the go → <span className="font-medium text-gray-700">+1 415 523 8886</span>
      </p>
    </div>
  );
}
